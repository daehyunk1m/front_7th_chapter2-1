var e=function(exports){function t(e,t){if(t.has(e))throw TypeError(`Cannot initialize the same private elements twice on an object`)}function n(e,n){t(e,n),n.add(e)}function r(e,t,n){if(typeof e==`function`?e===t:e.has(t))return arguments.length<3?t:n;throw TypeError(`Private element is not present on this object`)}return exports.assertClassBrand=r,exports.classPrivateMethodInitSpec=n,exports}({}),t;(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e){if(t.type!==`childList`)continue;for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();const n=`modulepreload`,r=function(e){return`/front_7th_chapter2-1/`+e},i={},a=function(e,t,a){let o=Promise.resolve();if(t&&t.length>0){let e=function(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))},s=document.getElementsByTagName(`link`),c=document.querySelector(`meta[property=csp-nonce]`),l=c?.nonce||c?.getAttribute(`nonce`);o=e(t.map(e=>{if(e=r(e,a),e in i)return;i[e]=!0;let t=e.endsWith(`.css`),o=t?`[rel="stylesheet"]`:``,c=!!a;if(c)for(let n=s.length-1;n>=0;n--){let r=s[n];if(r.href===e&&(!t||r.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${e}"]${o}`))return;let u=document.createElement(`link`);if(u.rel=t?`stylesheet`:n,t||(u.as=`script`),u.crossOrigin=``,u.href=e,l&&u.setAttribute(`nonce`,l),document.head.appendChild(u),t)return new Promise((t,n)=>{u.addEventListener(`load`,t),u.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${e}`)))})}))}function s(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return o.then(t=>{for(let e of t||[]){if(e.status!==`rejected`)continue;s(e.reason)}return e().catch(s)})},o=`/front_7th_chapter2-1/`;async function s(e={}){let{limit:t=20,search:n=``,category1:r=``,category2:i=``,sort:a=`price_asc`}=e,s=e.current??e.page??1,c=new URLSearchParams({page:s.toString(),limit:t.toString(),...n&&{search:n},...r&&{category1:r},...i&&{category2:i},sort:a}),l=await fetch(`${o}api/products?${c}`);return await l.json()}async function c(e){let t=await fetch(`${o}api/products/${e}`);return await t.json()}async function l(){let e=await fetch(`${o}api/categories`);return await e.json()}const u={categories:new Map,products:[],selectedProduct:{title:``,link:``,image:``,lprice:``,hprice:``,mallName:``,productId:``,productType:``,brand:``,maker:``,category1:``,category2:``,category3:``,category4:``,description:``,rating:0,reviewCount:0,stock:0,images:[]},filters:{search:``,category1:``,category2:``,sort:`price_asc`},pagination:{page:1,limit:20,total:0,totalPages:0,hasNext:!1,hasPrev:!1},isLoading:!1,cart:{isOpen:!1,selectedAll:!1,quantity:1,list:new Map},toast:{isOpen:!1,type:`success`},isError:!1},d=()=>{let e={...u},t=new Set,n=t=>t?e[t]:e,r=n=>{e={...e,...n},console.log(e),t.forEach(t=>t(e))},i=e=>(t.add(e),()=>{t.delete(e)});return{getState:n,setState:r,subscribe:i}},f=d();let p=[],m=!1,h=new WeakMap,g=new WeakMap;const _=(e,t)=>{p.push({callback:e,dependencies:t})},v=()=>{m||(m=!0,Promise.resolve().then(()=>{let e=[...p];p=[],e.forEach(({callback:e,dependencies:t})=>{let n=h.get(e),r=!n||!t||t.length!==n.length||t.some((e,t)=>e!==n[t]);if(r){let n=g.get(e);n&&n();let r=e();typeof r==`function`&&g.set(e,r),h.set(e,t)}}),m=!1}))},y=()=>{let{categories:e}=f.getState();e.size===0&&(f.setState({isLoading:!0}),l().then(e=>{let t=new Map;Object.entries(e).forEach(([e,n])=>{let r=Object.keys(n);t.set(e,r)}),f.setState({categories:t,isLoading:!1})}))},b=()=>{let{isLoading:e,products:t}=f.getState(),n=new Set(t.map(e=>e.category1));return _(y,[]),`
  <div class="space-y-3">
      ...
      <div class="space-y-2">
        ...
        ${e?`<div class="text-sm text-gray-500 italic">카테고리 로딩 중...</div>`:[...n,`디지털/가전`].map(e=>b.Category1(e)).join(``)}
        </div>
        <!-- 2depth 카테고리 -->
      </div>
      <!-- 기존 필터들 -->
  ...
  `,b.Limit=()=>{let e=f.getState(`pagination`),t=[10,20,50,100];return`
  ...
  `},b.Sort=()=>{let{sort:e}=f.getState(`filters`),t={price_asc:`가격 낮은순`,price_desc:`가격 높은순`,name_asc:`이름순`,name_desc:`이름 역순`};return`
  ...
  `;const S=()=>{let{hasNext:e}=f.getState(`pagination`),t=e?`text-center py-4`:`text-center py-4 text-sm text-gray-500`;return`
    <div class="${t}">
      ${e?S.HasNext():`모든 상품을 확인했습니다`}
    </div>
  `};S.HasNext=()=>`
  ...
  `.repeat(e),w=()=>{let{products:e}=f.getState();return e.map(e=>`
    ...
    `).join(``)},T=()=>{let{products:e,isLoading:t,pagination:{hasNext:n,total:r}}=f.getState();return`
  <div class="mb-6">
    <div>
    <!-- 상품 개수 정보 -->
    ${e.length>0?T.TotalCount({total:r}):``}
      <!-- 상품 그리드 -->
      ${T.Container({children:`
        ${t&&e.length===0?C({length:4}):w()}
        `})}
      ${t||!n?S():``}
    </div>
  </div>
  `};T.Container=({children:e})=>`
  <div class="grid grid-cols-2 gap-4 mb-6" id="products-grid">
    ${e}
  </div>
  `,T.TotalCount=({total:e})=>`
  <div class="mb-4 text-sm text-gray-600">
    총 <span class="font-medium text-gray-900">${e}개</span>의 상품
  </div>
  `;const E=()=>{let{products:e,isLoading:t,isError:n}=f.getState();return _(()=>{e.length===0&&!t&&(f.setState({isLoading:!0}),s().then(e=>{f.setState({...e,isLoading:!1})}).catch(()=>{f.setState({isError:!0,isLoading:!1,toast:{isOpen:!0,type:`error`}})}))},[]),`
  <!-- 검색 및 필터 -->
  ${x()}
  <!-- 상품 목록 -->
  ${n?`
  ...
  `,O=()=>{let e=f.getState(`isLoading`);return`
  ${e?O.Loading():O.Container()}
  `};O.Loading=()=>`
  ...
  <!-- 관련 상품 -->
  ${O.RelatedProducts()}
  `,O.Breadcrumb=()=>{let{category1:e,category2:t}=f.getState(`selectedProduct`);return`
  <nav class="mb-4">
  ...
  `},O.Item=()=>{let{title:e,image:t,lprice:n,brand:r,description:i,rating:a,reviewCount:o,stock:s}=f.getState(`selectedProduct`);return`
  ...
  `},O.Cart=()=>{let{productId:e}=f.getState(`selectedProduct`),{quantity:t}=f.getState(`cart`);return`
  ...
  `},O.RelatedProducts=()=>{let e=[];return`
  <div class="bg-white rounded-lg shadow-sm">
    ...
    <div class="p-4">
      <div class="grid grid-cols-2 gap-3 responsive-grid">
        ${e.length>0?e.map(e=>O.RelatedItem(e)).join(``):`관련 상품이 없습니다.`}
      </div>
    </div>
  </div>
  `},O.RelatedItem=e=>{let{productId:t,title:n,image:r,lprice:i}=e;return`
  ...
  `};const k=[{path:`/`,name:`home`,render:E},{path:`/product/:id`,name:`product`,render:O},{path:`*`,name:`notFound`,render:D}];var A=(t=new WeakSet,class{constructor(n=[]){e.classPrivateMethodInitSpec(this,t),this.routes=n,this.basePath=`/front_7th_chapter2-1/`,this.currentRoute=null,this.params={},this.queryParams={}}init(n){this.renderCallback=n,window.addEventListener(`popstate`,()=>{e.assertClassBrand(t,this,j).call(this)}),document.addEventListener(`click`,e=>{let t=e.target.closest(`a[data-link]`);if(t){e.preventDefault();let n=t.getAttribute(`href`)||`/`;this.navigate(n)}})}navigate(n,r={}){let{replace:i=!1}=r,a=this.basePath===`/`?n:this.basePath+n;i?window.history.replaceState(null,``,a):window.history.pushState(null,``,a),e.assertClassBrand(t,this,j).call(this)}getCurrentRoute(){let n=this.getPath(),r=e.assertClassBrand(t,this,M).call(this,n),i=this.routes.find(e=>e.path===`*`);return r??i}getPath(){let e=window.location.pathname;return e.startsWith(this.basePath)&&(e=e.slice(this.basePath.length)||`/`),e.startsWith(`/`)?e:`/`+e}getParams(){return this.params}getQueryParams(){let e=new URLSearchParams(window.location.search),t={};for(let[n,r]of e)t[n]=r;return t}});function j(){var e;let t=this.getCurrentRoute();if(!t)throw Error(`Not Found Route`);this.currentRoute=t,(e=this.renderCallback)?.call(this)}function M(n){for(let r of this.routes){if(r.path===n)return this.params={},r;if(r.path.includes(`:`)){let i=e.assertClassBrand(t,this,N).call(this,r.path),a=n.match(i);if(a)return this.params=e.assertClassBrand(t,this,P).call(this,r.path,a),r}}}function N(e){let t=e.replace(/\//g,`\\/`).replace(/:\w+/g,`([^\\/]+)`);return RegExp(`^${t}$`)}function P(e,t){let n={},r=e.match(/:\w+/g)||[];return r.forEach((e,r)=>{let i=e.slice(1);n[i]=t[r+1]}),n}const F=new A(k),I=({path:e})=>{let t=e.includes(`/product/`);return`
  ...
  `},L=({isDetail:e=!1})=>(console.log(`/front_7th_chapter2-1/`),e?`
  ...
  `),R=()=>{let{list:e}=f.getState(`cart`);return`
  ...
  `;const B=()=>{let{isOpen:e,type:t}=f.getState(`toast`),n={success:B.Success,info:B.Info,error:B.Error};return _(()=>{if(t){let e=setTimeout(()=>{f.setState({toast:{isOpen:!1}})},3e3);return()=>clearTimeout(e)}},[e]),`
  ...
  `;const V=async()=>{let{products:e,pagination:t}=f.getState(),{products:n,pagination:r}=await s({page:t.page+1,limit:t.limit});f.setState({products:[...e,...n],pagination:{...t,...r}})},H=()=>(_(()=>{let e=document.querySelector(`footer`);if(!e)return;let t=new IntersectionObserver(e=>{e.forEach(e=>{if(e.isIntersecting){let{path:e}=F.getCurrentRoute();if(e!==`/`)return;let{isLoading:t,pagination:n}=f.getState();if(t||!n.hasNext)return;f.setState({isLoading:!0}),V().then(()=>{f.setState({isLoading:!1})})}})},{root:null,rootMargin:`100px`,threshold:.1});return t.observe(e),()=>{t.disconnect()}},[]),`
    <footer class="bg-white shadow-sm sticky top-0 z-40">
      <div class="max-w-md mx-auto py-8 text-center text-gray-500">
        <p>© 2025 항해플러스 프론트엔드 쇼핑몰</p>
      </div>
    </footer>
  `);function U(){let{path:e,render:t}=F.getCurrentRoute(),{cart:n,toast:r}=f.getState();return`
  ...
  `}function W(e){if(!e)throw Error(`Component is required`);let t=document.querySelector(`#root`);t.innerHTML=e(),v()}const G=()=>{document.addEventListener(`click`,J),document.addEventListener(`change`,X)},K=()=>{f.setState({isLoading:!0,isError:!1}),s().then(e=>{f.setState({...e,isLoading:!1})}).catch(()=>{f.setState({isError:!0,isLoading:!1,toast:{isOpen:!0,type:`error`}})})},q=e=>{f.setState({isLoading:!0,isError:!1}),c(e).then(e=>{f.setState({selectedProduct:e,isLoading:!1})}).catch(()=>{f.setState({isError:!0,isLoading:!1,toast:{isOpen:!0,type:`error`}})})},J=e=>{let t=e.target;if(t.closest(`#back-btn`)&&window.history.back(),t.closest(`#retry-fetch-btn`)){K();return}if(t.closest(`#cart-open-btn`)){let e=f.getState(`cart`);if(e.isOpen)return;f.setState({cart:{...e,isOpen:!0}});return}if(t.closest(`#cart-modal-close-btn`)||t.closest(`.cart-modal-overlay`)){let e=f.getState(`cart`);if(!e.isOpen)return;f.setState({cart:{...e,isOpen:!1}});return}if((t.closest(`.add-to-cart-btn`)||t.closest(`#add-to-cart-btn`))&&(e.stopPropagation(),Y(t.dataset.productId),f.setState({toast:{isOpen:!0,type:`success`}})),t.closest(`.product-card`)){if(t.closest(`.add-to-cart-btn`))return;let e=t.closest(`[data-product-id]`),n=e.dataset.productId;q(n),F.navigate(`product/${n}`);return}if(t.closest(`.go-to-product-list`)){F.navigate(``);return}if(t.closest(`#toast-close-btn`)){f.setState({toast:{isOpen:!1}});return}if(t.matches(`#quantity-increase`)){let e=f.getState(`cart`);f.setState({cart:{...e,quantity:e.quantity+1}})}if(t.matches(`#quantity-decrease`)){let e=f.getState(`cart`);if(e.quantity<=1)return;f.setState({cart:{...e,quantity:e.quantity-1}})}},Y=e=>{let{products:t,cart:n}=f.getState();if(n.list.get(e))return;let{image:r,lprice:i,title:a}=t.find(({productId:t})=>t===e),o=n.list.set(e,{productId:e,image:r,lprice:i,title:a,quantity:1,selected:!1});f.setState({cart:{...n,list:o}}),f.setState({toast:{isOpen:!0,type:`success`}})},X=e=>{let t=e.target;if(t.matches(`#limit-select`)){let e=f.getState(`pagination`),n=+t.value;if(e.limit===n)return;f.setState({pagination:{...e,limit:n}});return}if(t.matches(`#sort-select`)){let e=f.getState(`filters`);if(e.sort===t.value)return;f.setState({filters:{...e,sort:t.value}});return}},Z=()=>{document.addEventListener(`input`,Q)},Q=e=>{let t=e.target;if(t.matches(`#search-input`)&&$(t.value),t.matches(`#quantity-input`)){let e=t.dataset.productId,n=+t.value,r=f.getState(`cart`),i=r.list.get(e);if(!i)return;let a=r.list.set(e,{...i,quantity:n});f.setState({cart:{...r,list:a}})}},$=e=>{let t=f.getState(`filters`);t.search!==e&&f.setState({filters:{...t,search:e}})},ee=()=>a(async()=>{let{worker:e}=await import(`./browser-0s8gz7ck.js`);return{worker:e}},[]).then(({worker:e})=>e.start({onUnhandledRequest:`bypass`,serviceWorker:{url:`/front_7th_chapter2-1/mockServiceWorker.js`}}));function te(){f.subscribe(()=>{W(U)}),F.init(()=>{W(U)}),W(U),G(),Z();let e=`
    <main class="max-w-md mx-auto px-4 py-4">
      <!-- 검색 및 필터 -->
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-4">
        <!-- 검색창 -->
